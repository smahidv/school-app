...
export default function StudentSideInfo({student} ) {
    ...
    return (
        ...
        {student && <div className="w-[30%] h-[400px] py-7 border-[1px] border-[solid] border-gray-200 rounded-lg">
            ...
            <div className=" mt-7">
                ...
                <div className="pl-5 grid gap-3  mt-4  relative after:absolute after:w-full after:h-[1px] after:bg-gray-200 after:bottom-[-30px] ">
            ...
            <div className=" mt-14">
                ...
                <div className="pl-5 text-xs mt-4">
