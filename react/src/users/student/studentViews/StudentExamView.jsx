        ...
        <div className="flex  min-h-[100dvh]  ">
            ...
            <div className="  py-10  p-[min(5em,_5dvw)]">
                <div className="flex justify-between   ">
                    ...
                    <button
                        type="button"
                        className="h-fit self-end border-gray-400 bg-[rgb(238,242,255)] border-solid border-[1px] px-6 rounded-full   "
                    >
                ...
                <ExamQuestion questions={questions} currentPage={meta.current_page}/>
