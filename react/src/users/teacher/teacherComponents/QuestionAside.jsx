...
export default function QuestionAside() {
  return (
    <aside className=" mr-5">
      ...
      <div className="mt-6 w-full">
        ...
        <div className='flex items-start gap-2 mt-3 p-1  hover:bg-[rgb(234,235,237)]'>
          <span className='text-sm'>1.</span>
          <svg fill="none" className='w-9' viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"><g fill="rgb(96,131,255)"><path d="m6.25 12c0-3.17564 2.57436-5.75 5.75-5.75 3.1756 0 5.75 2.57436 5.75 5.75 0 3.1756-2.5744 5.75-5.75 5.75-3.17564 0-5.75-2.5744-5.75-5.75z"/><path clip-rule="evenodd" d="m12 1.25c-5.93706 0-10.75 4.81294-10.75 10.75 0 5.9371 4.81294 10.75 10.75 10.75 5.9371 0 10.75-4.8129 10.75-10.75 0-5.93706-4.8129-10.75-10.75-10.75zm-9.25 10.75c0-5.10863 4.14137-9.25 9.25-9.25 5.1086 0 9.25 4.14137 9.25 9.25 0 5.1086-4.1414 9.25-9.25 9.25-5.10863 0-9.25-4.1414-9.25-9.25z" fill-rule="evenodd"/></g></svg>
          <p className='text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Beata</p>
        </div>
    </aside>
