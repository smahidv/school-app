...
<div class="p-10 relative overflow-x-auto shadow-md ">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <caption class="p-5 text-2xl font-bold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
           S1-Exam 1
        </caption>
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 font-bold text-xl text-green-700">
                    15/20
                </td>
            </tr>
